...
# **create**
> AsyncOperationResponse create(relative_path, module, stream, profiles, artifact=artifact, file=file, repository=repository)
...
module = 'module_example' # str | Modulemd name.
stream = 'stream_example' # str | Modulemd default stream.
profiles = None # object | Default profiles for modulemd streams.
...
repository = 'repository_example' # str | A URI of a repository the new content unit should be associated with. (optional)
    ...
    try:
        # Create a modulemd defaults
        api_response = api_instance.create(relative_path, module, stream, profiles, artifact=artifact, file=file, repository=repository)
        pprint(api_response)
...
# **list**
> PaginatedrpmModulemdDefaultsResponseList list(limit=limit, module=module, module__in=module__in, offset=offset, ordering=ordering, repository_version=repository_version, repository_version_added=repository_version_added, repository_version_removed=repository_version_removed, sha256=sha256, stream=stream, stream__in=stream__in, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = 'exclude_fields_example' # str | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List modulemd defaultss
        api_response = api_instance.list(limit=limit, module=module, module__in=module__in, offset=offset, ordering=ordering, repository_version=repository_version, repository_version_added=repository_version_added, repository_version_removed=repository_version_removed, sha256=sha256, stream=stream, stream__in=stream__in, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
...
# **read**
> RpmModulemdDefaultsResponse read(rpm_modulemd_defaults_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = 'exclude_fields_example' # str | A list of fields to exclude from the response. (optional)
    ...
    try:
        # Inspect a modulemd defaults
        api_response = api_instance.read(rpm_modulemd_defaults_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
