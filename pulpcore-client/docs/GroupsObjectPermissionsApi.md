# pulpcore.client.pulpcore.GroupsObjectPermissionsApi
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    api_instance = pulpcore.client.pulpcore.GroupsObjectPermissionsApi(api_client)
...
body = None # object | 
    ...
    try:
        ...
        print("Exception when calling GroupsObjectPermissionsApi->create: %s\n" % e)
```
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = pulpcore.client.pulpcore.GroupsObjectPermissionsApi(api_client)
    groups_object_permission_href = 'groups_object_permission_href_example' # str | 

    try:
        # Delete a permission
        api_instance.delete(groups_object_permission_href)
    except ApiException as e:
        print("Exception when calling GroupsObjectPermissionsApi->delete: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **groups_object_permission_href** | **str**|  | 
...
exclude_fields = 'exclude_fields_example' # str | A list of fields to exclude from the response. (optional)
    ...
    try:
        ...
        print("Exception when calling GroupsObjectPermissionsApi->list: %s\n" % e)
```
...
# **read**
> PermissionResponse read(groups_object_permission_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = 'exclude_fields_example' # str | A list of fields to exclude from the response. (optional)
    ...
    try:
        # Inspect a permission
        api_response = api_instance.read(groups_object_permission_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling GroupsObjectPermissionsApi->read: %s\n" % e)
```
