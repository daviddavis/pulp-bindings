...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a filesystem exporter
        api_response = api_instance.create(filesystem_exporter)
        pprint(api_response)
...
with pulpcore.client.pulpcore.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a filesystem exporter
        api_response = api_instance.delete(filesystem_exporter_href)
        pprint(api_response)
    except ApiException as e:
...
# **list**
> PaginatedFilesystemExporterResponseList list(limit=limit, name=name, name__contains=name__contains, name__icontains=name__icontains, name__in=name__in, name__startswith=name__startswith, offset=offset, ordering=ordering, fields=fields, exclude_fields=exclude_fields)
...
patched_filesystem_exporter = pulpcore.client.pulpcore.PatchedFilesystemExporter() # PatchedFilesystemExporter | 
    ...
    try:
        # Update a filesystem exporter
        api_response = api_instance.partial_update(filesystem_exporter_href, patched_filesystem_exporter)
        pprint(api_response)
    except ApiException as e:
...
# **read**
> FilesystemExporterResponse read(filesystem_exporter_href, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = 'exclude_fields_example' # str | A list of fields to exclude from the response. (optional)
    ...
    try:
        # Inspect a filesystem exporter
        api_response = api_instance.read(filesystem_exporter_href, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
    except ApiException as e:
...
filesystem_exporter = pulpcore.client.pulpcore.FilesystemExporter() # FilesystemExporter | 
    ...
    try:
        # Update a filesystem exporter
        api_response = api_instance.update(filesystem_exporter_href, filesystem_exporter)
        pprint(api_response)
    except ApiException as e:
