...
# **list**
> PaginatedSigningServiceResponseList list(limit=limit, name=name, offset=offset, ordering=ordering, fields=fields, exclude_fields=exclude_fields)
...
exclude_fields = 'exclude_fields_example' # str | A list of fields to exclude from the response. (optional)
    ...
    try:
        # List signing services
        api_response = api_instance.list(limit=limit, name=name, offset=offset, ordering=ordering, fields=fields, exclude_fields=exclude_fields)
        pprint(api_response)
